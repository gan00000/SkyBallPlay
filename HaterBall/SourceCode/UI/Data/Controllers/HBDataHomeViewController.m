...
@interface HBDataHomeViewController () <UIScrollViewDelegate>
...
@end
@implementation HBDataHomeViewController
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    HBDataHomeSubViewController *vc = [HBDataHomeSubViewController viewController];
    vc.type = index + 1;
