...
@interface HBNewsHomeRequest ()
@property (nonatomic, strong) NSMutableArray *newsList;
@property (nonatomic, assign) NSInteger page;
@end
@implementation HBNewsHomeRequest
- (void)requestWithSuccessBlock:(void(^)(NSArray<HBNewsModel *> *newsList))successBlock
    ...
    [HBBJHTTPServiceEngine getRequestWithFunctionPath:API_NEWS_HOME params:params successBlock:^(id responseData) {
