...
@interface HBRankHomeViewController () <UIScrollViewDelegate>
...
@end
@implementation HBRankHomeViewController
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    UIViewController *vc;
    if (index == 0) {
        HBRankEastWestViewController *ewVc = [HBRankEastWestViewController viewController];
        vc = ewVc;
    } else if (index == 1) {
        HBRankZoneViewController *zoneVc = [HBRankZoneViewController viewController];
        vc = zoneVc;
    }
