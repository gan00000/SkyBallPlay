...
#define API_NEWS_COMMENTS               @"api/get_post_comments" // 留言列表 post
#define API_NEWS_POST_COMMENT           @"api/save_post_comments" // 发表留言 post
#define API_NEWS_LIKE_ADD               @"api/save_comment_like" // 点赞 post
#define API_NEWS_HOT_COMMENT            @"api/get_post_hot_comments" // 获取热门留言
#define API_NEWS_ALL_COMMENT            @"get_post_all_comments" // 获取全部留言
