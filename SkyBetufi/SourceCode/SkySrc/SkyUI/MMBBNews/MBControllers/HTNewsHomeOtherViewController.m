...
@interface HTNewsHomeOtherViewController () <UIScrollViewDelegate>
...
@implementation HTNewsHomeOtherViewController

+ (instancetype)skargviewController {
    return kLoadStoryboardWithName(@"NewsHomeOther");
}
...
- (void)loadChildViewControllerByIndex:(NSInteger)index {
    ...
    UIViewController *vc;
    if (index == 0) {
        HTNewsHomeViewController *ewVc = [HTNewsHomeViewController skargviewController];
        vc = ewVc;
    } else if (index == 1) {
        HTFilmHomeViewController *zoneVc = [HTFilmHomeViewController skargviewController];
        vc = zoneVc;
    }
